...
(() => {
  ...
  const translations = {
    en: {
      ...
      'qr-code-generator-desc': 'Generate QR codes for any text or URL',
    ...
    es: {
      ...
      'qr-code-generator-desc': 'Genera códigos QR para cualquier texto o URL',
    ...
    ru: {
      ...
      'qr-code-generator-desc': 'Генерация QR-кодов для любого текста или URL',
    ...
    zh: {
      ...
      'other-products': '其他产品',
      'qr-code-generator-desc': '为任何文本或URL生成二维码',
