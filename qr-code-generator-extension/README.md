...
3. Нажмите "Load unpacked" и выберите папку `qr-code-generator-extension`

## Safari (macOS)
1. Установите Xcode (последняя версия)
2. В Xcode: File > New > Project > Safari Web Extension (или используйте `xcrun safari-web-extension-converter qr-code-generator-extension`)
