...
(() => {
  ...
  const translations = {
    ...
    zh: {
      ...
      'app-description': '随机挑选一道免费的 LeetCode 题目，省去无休止的翻页查找。',
      'loading': '正在加载题目…',
      'next-problem': '下一题',
      'copy': '复制',
      'copied': '已复制！',
      'copy-failed': '复制失败',
      'developed-by': '开发者',
      'error-loading': '题目加载失败。',
      'retry': '重试',
      'no-problems-filter': '没有符合该筛选条件的题目。',
      'settings-reset': '设置已重置',
      'cache-refreshed': '题目列表已刷新',
      'refresh-failed': '刷新失败',
      'problems-cached': '已缓存 {count} 道免费题目',
      'not-loaded-yet': '尚未加载',
      'updated-ago': '{time}前更新',
